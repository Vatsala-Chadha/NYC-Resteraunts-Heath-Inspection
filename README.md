...
- [sql nyc_inspections data preparation.sql](sql%20nyc_inspections%20data%20preparation.sql) → SQL queries for data preparation  
- [sql nyc_inspections data analysis.sql](sql%20nyc_inspections%20data%20analysis.sql) → SQL queries for data analysis  
- [NYC restaurants health inspection analysis dashboard.png](NYC%20restaurants%20health%20inspection%20analysis%20dashboard.png) → Dashboard with all visualizations  
- [cuisine classification.csv](cuisine%20classification.csv) → Cuisine Classification table  
